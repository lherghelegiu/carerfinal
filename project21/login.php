...
<body>
    ...
    <h1 class="welcome text-center">Welcome to <br> Services</h1>
        ...
        <h2 class='login_title text-center'>Account Type</h2>
        <hr>
            <form class="form-signin" method="POST">
            	<button style="background-color: blue; border-color: blue;" class="btn btn-lg btn-primary" name="submit" type="submit"><a a href="login-page.php">Coordinator</a></button>
                <button class="btn btn-lg btn-primary" name="submit" type="submit"><a a href="login-page.php">Carer</a></button>
                <button style="background-color: green; border-color: green;" class="btn btn-lg btn-primary" name="submit" type="submit"><a a href="e-login.php">Elderly</a></button>
            </form><!-- /form -->
        </div><!-- /card-container -->
    </div><!-- /container -->
</html>
