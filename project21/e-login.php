    ...
    <h1 class="welcome text-center">Welcome to <br> Services</h1>
        ...
        <hr>
            <form class="form-signin" method="POST">
                ...
                <input type="text" id="username" name="username" class="login_box" placeholder="Name" required autofocus>
                <p class="input_title">Surname</p>
                <input type="text" id="password" name="password" class="login_box" placeholder="Surname" required>
...
<?php
  if(isset($_POST['submit'])) {
    ...
    $sql = "SELECT * FROM elderly WHERE name = '$username' AND surname = '$pass'";
    ...
    if (!$row = $result->fetch_assoc()) {
      ...
      $_SESSION['id'] = $row['id'];
      	...
      	<script type="text/javascript">
			window.location.href = 'elderly/home.php';
		</script>
